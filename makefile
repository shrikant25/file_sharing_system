...
processor_r_files := processor_r.c shared_memory.c partition.c connect_and_prepare.c

processor_s_target = processor_s
processor_s_files := processor_s.c shared_memory.c partition.c connect_and_prepare.c

sender_target = sender
sender_files := sender.c shared_memory.c partition.c connect_and_prepare.c

receiver_target = receiver
receiver_files := receiver.c shared_memory.c partition.c connect_and_prepare.c
